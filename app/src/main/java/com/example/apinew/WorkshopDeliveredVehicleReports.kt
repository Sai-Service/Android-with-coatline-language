...
class WorkshopDeliveredVehicleReports : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_workshop_delivered_vehicles)
                ...
                jsonData?.let {
                    ...
                    runOnUiThread {
                        val adapter = ArrayAdapter(
                            this@WorkshopDeliveredVehicleReports,
                            android.R.layout.simple_spinner_item,
                            cities
                        )
    ...
    private fun fetchUninvoice() {
        ...
        if (selectedType == "SELECT DEPARTMENT") {
            ...
            val url = if (deptName == "SUPERADMIN") {
                ApiFile.APP_URL + "/srAccounts/srStockDelvDetailsByOu?ouId=$selectedCityCode&dept=$selectedType"
            } else {
                ApiFile.APP_URL + "/srAccounts/srStockDelvDetailsByOu?ouId=$ouId&dept=$selectedType"
            }
