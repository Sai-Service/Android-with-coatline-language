...
class WorkshopStockReport : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_workshop_stock_report)
    ...
    private fun fetchUninvoice() {
        ...
        if (selectedType == "SELECT DEPARTMENT") {
            ...
            val url = if (deptName == "SUPERADMIN") {
                ApiFile.APP_URL + "/srAccounts/srStockDetailsByOu?ou=$selectedCityCode&dept=$selectedType"
            } else {
                ApiFile.APP_URL + "/srAccounts/srStockDetailsByOu?ouId=$ouId&dept=$selectedType"
            }
                        ...
                        if (jsonObject.has("obj")) {
                            ...
                            for (i in 0 until jsonArray.length()) {
                                ...
                                val data = listOf(
                                    ...
                                    stockItem.optString("REGNO", ""),
                                    stockItem.optString("VIN", ""),
                                    stockItem.optString("CHASSISNO", ""),
                                    stockItem.optString("ENGINNO", ""),
                                    stockItem.optString("FUEL_DESC", ""),
                                    stockItem.getString("MODELDESC"),
                                    stockItem.optString("VARIANT", ""),
                                    stockItem.optString("COLOR", ""),
                                    stockItem.getString("ERPLOC"),
                                    stockItem.optString("VEH_STATUS", ""),
                                    stockItem.optString("STATUS", ""),
                                    stockItem.optString("CUSTNAME", ""),
                                    stockItem.getString("CONTACTNO"),
                                    stockItem.optString("DMSLOCATION", ""),
                                    stockItem.optString("SERVICEADVISOR", ""),
                                    stockItem.optString("REG_DATE", "")
                                )
