...
//    private lateinit var veh1:ImageView
//    private lateinit var veh2:ImageView
//    private lateinit var veh3:ImageView
//    private lateinit var veh4:ImageView
//    private lateinit var veh5:ImageView
//
...
////        veh1=findViewById(R.id.VEH_IMAGE)
////        veh2=findViewById(R.id.VEH_IMAGE2)
////        veh3=findViewById(R.id.VEH_IMAGE3)
////        veh4=findViewById(R.id.VEH_IMAGE4)
////        veh5 =findViewById(R.id.VEH_IMAGE5)
//
//
//
//
...
//    }
//
////    private fun fetchChassisImage(chassisNo: String) {
////        val client = OkHttpClient()
////        val request = Request.Builder()
////            .url("${ApiFile.APP_URL}/invstock/Download?chassisNo=$chassisNo")
////            .build()
////
////        GlobalScope.launch(Dispatchers.IO) {
////            try {
...
////                            val downloadUrl = "${ApiFile.APP_URL}/invstock/downloadImage?imagePath=$imagePath"
////
...
////                    }
////                } ?: run {
////                    Log.e("API_ERROR", "No response received for chassis no: $chassisNo")
////                }
////            } catch (e: Exception) {
////                e.printStackTrace()
////                runOnUiThread {
////                    Log.e("API_ERROR", "Error fetching images for chassis no: $chassisNo - ${e.javaClass.simpleName}: ${e.message}")
////                    Toast.makeText(this@ChassisActivity, "Error fetching images for chassis no: $chassisNo", Toast.LENGTH_SHORT).show()
////                }
////            }
////        }
////    }
