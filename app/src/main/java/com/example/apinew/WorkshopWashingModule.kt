...
//
//
//class WorkshopWashingModule : AppCompatActivity() {
...
//    private lateinit var serviceAdvisorEditText:EditText
//    private lateinit var serviceAdvisorTxtView:TextView
...
//        setContentView(R.layout.activity_workshop_washing_module)
//
...
//        serviceAdvisorEditText=findViewById(R.id.serviceAdvisorEditText)
//        serviceAdvisorTxtView=findViewById(R.id.serviceAdvisorTxtView)
//
//
//
//
...
//        serviceAdvisorEditText.visibility=View.GONE
//        serviceAdvisorTxtView.visibility=View.GONE
//
...
////        }
//        btnPickTime.setOnClickListener {
//            showDateTimePicker(txtSelectedTime)
//        }
//
...
//            // Once the date is selected, show the TimePickerDialog
//            showTimePicker(year, month, dayOfMonth, textView)
//        }, currentYear, currentMonth, currentDay)
//
//        datePickerDialog.show()
//    }
//
//    private fun showTimePicker(year: Int, month: Int, dayOfMonth: Int, textView: TextView) {
//        val calendar = Calendar.getInstance()
...
//            updatedCalendar.set(year, month, dayOfMonth, selectedHour, selectedMinute)
//
//            // Get the formatted time (HH:mm)
//            val formattedTime = String.format("%02d:%02d",dayOfMonth,month,year,selectedHour, selectedMinute)
//
//            // Get the current date and time
//            val currentDate = updatedCalendar.time
//
//            // Format the date and time in ISO 8601 format: yyyy-MM-dd'T'HH:mm:ss.SSSZ
...
//
//            // Assign the formatted date-time to the variable
//            dateTimeToSend = formattedDateTime
//
//            // Send the formatted date-time to the backend
//            sendToBackend(formattedDateTime)
//        }, hour, minute, true)
//
...
//
//
//    private fun sendToBackend(dateTime: String) {
//        // Create a request with the formatted date-time string
//        // Example: make API call with the formatted date-time (formattedDateTime)
//    }
//
//
//
...
//                    runOnUiThread {
//                        val adapter = ArrayAdapter(this@WorkshopWashingModule, android.R.layout.simple_spinner_item, cities
//                        )
...
//                val jsonData = response.body?.string()
//                jsonData?.let {
//                    val cities = parsewashStageType(it)
//                    runOnUiThread {
//                        val adapter = ArrayAdapter(this@WorkshopWashingModule, android.R.layout.simple_spinner_item, cities
//                        )
//                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
//                        washStageTypeLov.adapter = adapter
//                    }
//                }
//            } catch (e: Exception) {
//                e.printStackTrace()
...
//        serviceAdvisorEditText.visibility=View.VISIBLE
//        serviceAdvisorTxtView.visibility=View.VISIBLE
//    }
//
...
//        serviceAdvisorEditText.visibility=View.GONE
//        serviceAdvisorTxtView.visibility=View.GONE
//        serviceAdvisorEditText.setText("")
//    }
//
...
//                        "Details for 1st stage found in washing table" -> {
//                            runOnUiThread {
//                                populateFieldsAForFirstStage(jcData3)
//                                populateFieldsAfterInSearch()
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Details for 1st stage found in washing table $vehNo",
//                                    Toast.LENGTH_SHORT
//                                ).show()
//                                fetchwashStageNumber()
//                            }
//                        }
//                        "Details for 2nd stage found in washing table" -> {
//                            runOnUiThread {
//                                populateFieldsAForSecondStage(jcData3)
//                                populateFieldsAfterInSearch()
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Details for 2nd stage found in washing table: $vehNo",
//                                    Toast.LENGTH_SHORT
//                                ).show()
//                                fetchwashStageNumber()
//                            }
//                        }
//                        "Details for 3rd stage found in washing table" -> {
//                            runOnUiThread {
//                                  populateFieldsAForThirdStage(jcData3)
//                                populateFieldsAfterInSearch()
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Details for 3rd stage found in washing table: $vehNo",
//                                    Toast.LENGTH_SHORT
//                                ).show()
//                                fetchwashStageNumber()
//                            }
...
//                                populateFieldsAfterInSearch()
//                                timePickerLL.visibility=View.VISIBLE
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
...
//
//        val status=washStageTypeLov.selectedItem.toString()
//        if(status=="Select Washing Type"){
//            Toast.makeText(this,"Please select washing type.",Toast.LENGTH_SHORT).show()
//            return
//        }
//        val washingSupervisor=serviceAdvisorEditText.text.toString()
//        if(washingSupervisor.isEmpty()){
//            Toast.makeText(this,"Please Enter Washing Supervisor Name.",Toast.LENGTH_SHORT).show()
//            return
//        }
//
//
...
//                }
//            }
//            if (::dateTimeToSend.isInitialized) {
//                if(dateTimeToSend.isNotEmpty() ) {
//                    put("promisedTime",dateTimeToSend)
//                }
//            }
////            if(txtSelectedTime.text.isNotEmpty()){
////                put("promisedTime",txtSelectedTime.text)
////            }
//            put("status",status)
...
//            put("status",status)
//            put("washingSupervisor",washingSupervisor)
//            put("model","-")
//        }
//
...
//
//                        when {
//                            message.contains("Select air blow station wash", ignoreCase = true) -> {
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Select air blow station wash",
//                                    Toast.LENGTH_LONG
//                                ).show()
//                            }
//                            message.contains("Underbody Station wash is pending.", ignoreCase = true) -> {
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Underbody Station wash is pending.",
//                                    Toast.LENGTH_LONG
//                                ).show()
//                            }
//                            message.contains("Engine Room station wash is pending.", ignoreCase = true) -> {
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Engine Room station wash is pending.",
//                                    Toast.LENGTH_LONG
//                                ).show()
//                            }
//
//                            message.contains("Loose items station wash is pending.", ignoreCase = true) -> {
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Loose items station wash is pending.",
//                                    Toast.LENGTH_LONG
//                                ).show()
//                            }
//                            message.contains("Vehicle Interior station wash is pending.", ignoreCase = true) -> {
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Vehicle Interior station wash is pending.",
//                                    Toast.LENGTH_LONG
//                                ).show()
//                            }
//                            message.contains("Vehicle Exterior station wash is pending.", ignoreCase = true) -> {
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Vehicle Exterior station wash is pending.",
//                                    Toast.LENGTH_LONG
//                                ).show()
//                            }
//                            message.contains("Glass & polish station wash is pending.", ignoreCase = true) -> {
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Glass & polish station wash is pending.",
//                                    Toast.LENGTH_LONG
//                                ).show()
//                            }
//                            responseCode == 200 -> {
...
//    }
//
//    private fun populateFieldsAForFirstStage(jcData: allData) {
//        val table = findViewById<TableLayout>(R.id.tableLayout2)
//        table.removeAllViews()
//
//        val detailsMap = mutableMapOf(
...
//            "WASHING ADVISOR" to jcData.WASHING_SUPERVISOR,
//            "1ST STAGE IN TIME" to jcData.FS_IN_TIME,
//            "AIR BLOW STN" to jcData.AIR_BLOW_STN,
//            "UNDERBODY STN" to jcData.UNDERBODY_STN,
...
//    }
//
//    private fun populateFieldsAForSecondStage(jcData: allData) {
//        val table = findViewById<TableLayout>(R.id.tableLayout2)
//        table.removeAllViews()
//
//        val detailsMap = mutableMapOf(
...
class WorkshopWashingModule : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enterVehNumber.filters = arrayOf(noSpaceFilter)
    ...
    private fun workShopTestDriveVehHistory() {
        val intent = Intent(this@WorkshopWashingModule, WorkshopWashingVehicleHistory::class.java)
...
//                val jsonData = response.body?.string()
//                jsonData?.let {
//                    val stages = parsewashStageType(it) // Get the list of washing stages
//
//                    runOnUiThread {
...
//
//                        val selectedStages = mutableSetOf<String>() // Store selected values
//
//                        // Start loop from index 1 to skip "Select Washing Type"
//                        for (i in 1 until stages.size) {
//                            val stage = stages[i]
//
//                            val checkBox = CheckBox(this@WorkshopWashingModule)
//                            checkBox.text = stage
...
//                                Toast.makeText(
//                                    this@WorkshopWashingModule,
//                                    "Selected: ${selectedStages.joinToString(", ")}",
//                                    Toast.LENGTH_SHORT
//                                ).show()
//                            }
//                        }
