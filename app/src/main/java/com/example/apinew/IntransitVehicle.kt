...
class IntransitVehicle : AppCompatActivity() {
...
//    private lateinit var fromDateTextView: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_intransit_vehicle)
...
//        val selectedCity = citySpinner.selectedItem.toString()
        ...
        if (selectedType == "SELECT VEHICLE TYPE") {
            ...
            val url = if (deptName == "SUPERADMIN") {
                ApiFile.APP_URL + "/accounts/reportIntransit?ouId=$selectedCityCode&vehType=$selectedType"
            } else {
                ApiFile.APP_URL + "/accounts/reportIntransit?ouId=$ouId&vehType=$selectedType"
            }

//        val url = ApiFile.APP_URL + "/accounts/reportIntransit?ouId=$ouId"
                    ...
                    jsonData?.let {
                        ...
                        for (i in 0 until jsonArray.length()) {
                            ...
                            val data = listOf(
                                ...
                                formatDateTime(stockItem.optString("GRN_DATE")),
                                stockItem.optString("MUL_INV_NO"),
                                formatDateTime(stockItem.optString("MUL_INV_DT")),
    ...
    private fun updateTableView(stockItems: List<List<String>>) {
        ...
        val headers = listOf("SR.NO.","VIN", "CHASSIS NO","ENGINE NO","MODEL DESC","FUEL DESC","VARIANT CODE","VARIANT DESC","COLOUR",
            "GRN NO","GRN DATE",
            "MUL INV NO","MUL INV DATE",
            "VEH STATUS","STATUS","LOCATION")
