...
class SummaryLocationWise : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_summary_locationwise)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            try {
                ...
                jsonData?.let {
                    ...
                    runOnUiThread {
                        val adapter = ArrayAdapter(this@SummaryLocationWise, android.R.layout.simple_spinner_item, cities
                        )
    ...
    private fun fetchCountWise() {
        ...
        val url = if (deptName == "SUPERADMIN") {
            ApiFile.APP_URL + "/accounts/reportLocCount?ouId=$selectedCityCode"
        } else {
            ApiFile.APP_URL + "/accounts/reportLocCount?ouId=$ouId"
        }
