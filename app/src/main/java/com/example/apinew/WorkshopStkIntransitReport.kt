...
class WorkshopStkIntransitReport : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_workshop_stk_intransit)
                ...
                jsonData?.let {
                    ...
                    runOnUiThread {
                        val adapter = ArrayAdapter(
                            this@WorkshopStkIntransitReport,
                            android.R.layout.simple_spinner_item,
                            cities
                        )
    ...
    private fun fetchUninvoice() {
        ...
        if (selectedType == "SELECT DEPARTMENT") {
            ...
            val url = if (deptName == "SUPERADMIN") {
                ApiFile.APP_URL + "/srAccounts/srStkTrfDetailsByOu?ouId=$selectedCityCode&dept=$selectedType"
            } else {
                ApiFile.APP_URL + "/srAccounts/srStkTrfDetailsByOu?ouId=$ouId&dept=$selectedType"
            }
