...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    fun getWashingVehicleHistoryByChassisNumber( // used in WorkshopWashingReport for fetchTransferListData()
        chassisNo: String,ouId:String
    ): String {
        return "${ApiFile.APP_URL}/vehWashingReport/vehWashHistoryByChassisNo?chassisNo=$chassisNo&ouId=$ouId"
    }
