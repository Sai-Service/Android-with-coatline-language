...
import com.example.chassisimagecapture.R
...
//        private fun navigateToHomeActivity(attribute1: String, ouId: Int,login_name:String)
        val intent = Intent(this@MainActivity, CaptureImage::class.java)
