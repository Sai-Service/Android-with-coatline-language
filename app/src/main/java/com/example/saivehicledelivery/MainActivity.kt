...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val version = when (ApiFile.APP_URL) {
            "http://182.72.0.216:7485/SaiVehicleDelivery" ->  "PRODUCTION"
            "http://115.242.10.86:6101/SaiVehicleDelivery" ->"CLONE"
            "http://10.0.2.2:8081" -> "LOCALHOST"
            "http://203.115.117.157:6101/SaiVehicleDelivery" ->"CLONE"
            "http://115.242.10.85:7485/SaiVehicleDelivery"->"PRODUCTION"
            ...
            override fun onResponse(call: Call<LoginResponse>, response: Response<LoginResponse>) {
                if (response.isSuccessful) {
                    ...
                    if (loginResponse != null && loginResponse.code == 200) {
                        ...
                        val userContact=loginResponse.userContact
                        ...
                        Toast.makeText(this@MainActivity, "Login successful", Toast.LENGTH_LONG)
                            .show()
                        if (ouId != null &&location!=null&&locId!=null&&location_name!=null&&deptName!=null&&userContact!=null&&userName!=null) {
                            navigateToHomeActivity(ouId,login_name,location,locId,location_name,deptName,userContact,userName)
//                            navigateToHomeActivity(attribute1, ouId,login_name)
    ...
    private fun navigateToHomeActivity(ouId: Int,login_name:String,location:String,locId:Int,location_name:String,deptName:String,userContact:String,userName:String) {
